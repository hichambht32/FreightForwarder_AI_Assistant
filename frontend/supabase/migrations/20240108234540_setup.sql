...
AS $$
DECLARE
  project_url TEXT := 'https://ywyzmqhwpyxjrrpbmoso.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inl3eXptcWh3cHl4anJycGJtb3NvIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcxODg5NjcwNywiZXhwIjoyMDM0NDcyNzA3fQ.bc0nWXaulVgaUgHffWdTF4qUb7XjHsywHJPl9KpgNNg'; -- full access needed for http request to storage
