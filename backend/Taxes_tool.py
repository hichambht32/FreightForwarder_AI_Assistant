...
(SQLTableSchema(
    ...
    context_str="This table records information about import duties, including Duty Import (DI), Taxe Provisoire d'Importation (TPI), Taxe sur la Valeur Ajoutée (TVA),the HS code, associated product names, and categoriesand the douane chapter. Each entry represents a unique set of import duty details."
))
...
def ImportDuties(input: str) -> str:
