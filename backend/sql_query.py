...
Ensure the use of column names present in the schema description, and do not query for non-existent columns.Use the 'CAST' function to treat strings as numbers for numerical columns.

use 'LIKE' and '%name%' when searching through names.
