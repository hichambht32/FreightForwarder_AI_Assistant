...
Meubles; mobilier médico-chirurgical; articles de literie et similaires; appareils d'éclairage non dénommés ni compris ailleurs; lampes-réclames; enseignes lumineuses et articles similaires; constructions préfabriquées
    ...
    for chapter_num, chapter_name in zip(chapter_numbers, chapter_names_list):
        ...
        try:
            ...
            docs = SimpleDirectoryReader(
                input_files=[f"./ProcessedPDFs/Chap{chapter_num}.pdf"]
            ).load_data()
