...
(SQLTableSchema(
    ...
    context_str="This table contains information about required documents, including document numbers, names, issuers,the corresponding HS customs position codes, associated product names, and categoriesand the douane chapter. Each entry represents a unique document requirement."
))
...
Ensure the use of column names present in the schema description, and do not query for non-existent columns.include important columns such as document name,issuer,code and designation of the product,libelle d'extrait.  
...
qp = QP(
    modules={
        ...
        "sql_retriever": execute_query_component,
